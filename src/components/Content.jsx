...
function Content() {
  return (
    <div className="w-full flex flex-col items-center py-[60px] px-[20px] gap-8 w-[390px] h-[906px] lg:py-[120px] lg:px-[86px] lg:gap-[60px] w-[350px] lg:w-full lg:h-[1268px] bg-white flex-none  ">
      <div className="mx-auto flex flex-col items-center p-0  gap-4 w-[350px] h-[208px] lg:gap-[24px] lg:w-full lg:max-w-[1176px] lg:h-[192px] order-0">
        <div className="flex flex-col items-center p-0 gap-3 w-full max-w-[390px] h-[92px] lg:gap-[16px] lg:w-[1176px] lg:h-[112px] flex-none order-0 grow-0">
          ...
          <h1 className=" w-[350px] lg:w-[1176px]  font-manrope font-extrabold text-[30px] leading-[40px] lg:text-[56px] lg:leading-[68px] text-center text-[#2D2F33] flex-none order-1 grow-0">
            Everything You Need
          </h1>
        </div>
