...
function BannerContent({ logo, text }) {
  return (
    <div className="flex flex-col items-start lg:items-start py-[20px] lg:py-0 px-0 lg:p-0 gap-2 lg:gap-6 w-[350px] h-[316px] lg:w-[1168px] lg:h-[356px] flex-none order-1 grow lg:relative lg:z-[1]">
      ...
      <button className="flex justify-start items-center py-[10px] px-[20px] gap-[6px] w-[162px] h-[40px]  lg:py-4 lg:px-1 lg:gap-[10px] lg:w-[234px] lg:h-[60px] bg-[#2D2F33] rounded-[80px] flex-none order-2 grow-0">
