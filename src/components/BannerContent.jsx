...
function BannerContent({ logo, text }) {
  return (
    <div className="flex flex-col items-center lg:items-start py-[20px] lg:py-0 px-0 lg:p-0 gap-2 lg:gap-6 w-[350px] h-[44px] lg:w-[1168px] lg:h-[356px] flex-none order-1 grow lg:relative lg:z-[1]">
      <div className="flex flex-col items-start p-0 gap-3 w-[302px] h-[124px] lg:w-[824px] lg:h-[192px] flex-none order-0 grow-0">
